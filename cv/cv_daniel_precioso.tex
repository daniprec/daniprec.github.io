...
%----------FONT OPTIONS-------------------
\usepackage[scaled]{helvet} % uses the font helvetica
...
\begin{document}
	...
	% \small{
	\textbf{7+ years} taking ML/DL projects from concept to production across healthcare, energy, insurance, and maritime logistics. I combine technical rigor (PhD, 5 Q1 publications) with \textbf{client-facing delivery}: presenting to executives, deploying production systems (Flask, CI/CD), and translating complex models into business value. Currently coordinating technical delivery for \textbf{Vienna Insurance Group}, where I manage stakeholder communications and deploy ML applications for climate risk analysis.
	% }
	%--------------------------------------------
	...
	\resumeSectionType{Languages}{:}{Python (expert), R, MATLAB, SQL}
	\resumeSectionType{ML/DL}{:}{scikit-learn, TensorFlow, PyTorch, Keras, JAX}
	\resumeSectionType{GenAI \& LLMs}{:}{OpenAI API, Claude, Gemini, Multi-agent systems}
	\resumeSectionType{MLOps \& DevOps}{:}{Git (CI/CD, pre-commit hooks), Flask, Docker (basics)}
	\resumeSectionType{Cloud \& Data}{:}{AWS S3, Pandas, NumPy, Streamlit}
	...
	\resumeItemListStart{}
	\resumeItem{Coordinate \textbf{client-facing technical delivery} for Vienna Insurance Group: manage stakeholder presentations, deploy \textbf{production Flask applications} (PythonAnywhere), and implement \textbf{CI/CD workflows}. Built climate risk models (DLNMs, Relative Risk curves) used by VIG for portfolio decisions.}
	\resumeItem{Implemented Kolmogorov-Arnold Networks (KANs) for weather forecasting, improving prediction accuracy.}
	\resumeItem{Leverage \textbf{GenAI tools} (Claude, OpenAI, Gemini) for development acceleration.}
	...
	\resumeItemListStart{}
	\resumeItem{Built and deployed route optimization models for maritime clients, demonstrating \textbf{5-40\% reductions} in fuel consumption through weather-integrated navigation. Managed data workflows using \textbf{AWS S3} for large-scale datasets.}
	...
	\resumeItem{Awarded a prestigious Torres Quevedo Grant (2023) by the Spanish Ministry of Science to develop R\&D activities at Canonical Green (grant declined for strategic reasons).}
	\resumeItemListEnd{}
	...
	\resumeItem{Implemented \textbf{Git workflows with CI/CD practices} for team collaboration on production codebase.}
	\resumeItemListEnd{}
	...
	\resumeItemListStart{}
	\resumeItem{Built neural network models using Keras and TensorFlow for non-intrusive load monitoring (NILM) in energy sector.}
	\resumeItemListEnd{}
