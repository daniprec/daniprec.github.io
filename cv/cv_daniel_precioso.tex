...
\begin{document}
	...
	\resumeItem{Contributed to three research projects delivering measurable impact:
		\begin{itemize}
			\item Built climate impact models simulating insurance risk under SSP-RCP scenarios that VIG used for portfolio strategy.
	...
	\resumeItemListStart{}
	\resumeItem{Implemented Kolmogorov-Arnold Networks for weather forecasting, advancing ML-based meteorological prediction accuracy.}
	...
	\resumeItemListStart{}
	\resumeItem{Built predictive models analyzing climate change impact on insurance risk that VIG used for data-driven portfolio strategies.}
